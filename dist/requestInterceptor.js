...
function requestInterceptor(options = {}) {
    const { parseBody = true, maxBodySize = 1024 * 1024, // 1MB por padrão
    onRequest, enableLogging = true, logLevel = 'info', enablePerformanceMonitoring = true, enableAuditLogging = false, customLogger } = options;
